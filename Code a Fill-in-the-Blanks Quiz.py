...
""" This function take input difficulty level from user and return string of difficulty and answer"""
...
def remove_spaces_before_punc(fib_string):
    ...
    """ it take string as input and return same string without spaces """
...
def guess_check(blank_number, fib, answers, answer):
    ...
    """ It take in string blank number, checking case sensitive and answer key and retun next blank number"""
